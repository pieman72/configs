...
syn keyword cssFont contained sans-serif serif arial verdana times courier helvetica gillsans gillsansbold
...
syn match cssGeneratedContentAttr contained "\<\(lower\|upper\)-\(roman\|greek\|latin\)\>"
...
syn keyword cssRenderProp contained position top bottom direction opacity
...
syn keyword cssIEJankProp contained filter
syn keyword cssIEJankValue contained alpha
...
syn region cssDefinition transparent matchgroup=cssBraces start='{' end='}' contains=css.*Attr,css.*Prop,cssComment,cssValue.*,cssColor,cssURL,cssImportant,cssError,cssStringQ,cssStringQQ,cssFunction,cssUnicodeEscape,cssIEJankValue,cssFont
