...
" most Scala keywords
syn keyword scalaKeyword abstract case catch do else extends final finally findAllIn findFirstIn for foreach forSome if implicit lazy match new null override partition private protected requires return sealed super this throw try type while with yield
